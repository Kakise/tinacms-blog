...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-border bg-main font-base text-mtext transition-colors data-[state=selected]:bg-bw data-[state=selected]:text-mtext',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn('mt-4 text-sm font-base text-mtext', className)}
    {...props}
  />
))
